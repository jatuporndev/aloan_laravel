    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href=#><img src="img/rsalogo.png" alt=""> ALOAN</a>
...
<section class="home_banner_area" id="home">
                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-6 col-xl-5 offset-xl-7">
                        <div class="banner_content">
                            <h3>A Loan Platfrom<br/>money & faster</h3>
                            <p>lele kaw san</p>
                            <a class="banner_btn" href="{{ url('/multi') }}">Get Stated<i class="ti-arrow-right"></i></a>
                        </div>
                    </div>
    ...
    <!--================End Home Banner Area =================-->
      ...
      <!--================Service  Area =================-->
      <section class="service-area area-padding" id="about">
        <div class="container">
            <div class="row">
                <!-- Single service -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="area-heading">
                        <h4>Peer 2 Peer<br>Lending </h4>
                        <h6>is an electronic platform provider which takes a matchmaker role between lenders and borrowers. </h6>

                        <p>Its roles also include facilitating loan contracts and carrying out fund transfers and repayments between the parties. The benefit of having the platform is to be an alternative means for people to gain access to credit with appropriate costs, while also providing more channels for investment. Prior to applying for a license from the Ministry of Finance, BOT requires any person who would like to operate the business to test their service in the regulatory sandbox, in order to ensure proper risk management and consumer protection.</p>
                    </div>
                    <div class="row">
    ...
    <!--================About Area End =================-->
     ...
     <!--================Feature  Area =================-->
     <section class="feature-area area-padding bg_one" id="feature">
        <div class="container">
            <div class="row align-items-center">
