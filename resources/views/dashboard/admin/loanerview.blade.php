...
<!-- {{$view -> lastname}}
<a href="admin/loanerview/update1/{{$view -> LoanerID}}" button class="btn btn-primary" type="button" > pass </a>

<a href="admin/loanerview/update2/{{$view -> LoanerID}}" button class="btn btn-danger" type="button" > unpass </a>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Profile Loaner# {{$view -> LoanerID}} </h3>
